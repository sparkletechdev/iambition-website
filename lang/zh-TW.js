  ...
  company: {
    aboutUs: {
      ...
      landingContent: [
        ...
        `安全是回家的唯一一條路，雄欣科技基於「讓生命更安全 讓生活更美好」的使命，自主研發前瞻AI感知系統，透過專業顧問規劃，我們能在不危害隱私權的情境下，早期預防安全意外事件、即時偵測場域與人的異常狀況、全方位移動式通報。協助政府機關、公司工廠、校園、醫療照護機構、購物與展覽場域等業主，透過數位賦能與數位轉型的流程，徹底解決產業痛點，並提升「場域安全」「管理效率」與「服務品質」等ESG指標。`,
    ...
    landing: [
      {
        ...
        landingContent: [
          `台北國際電腦展是亞洲最具代表性之資訊產業專業展，定位為建構全球科技生態系，聚焦開創運算、智慧驅動、數位韌性、無限體驗、創新與新創等主題，提供全球創業先鋒產業知識碰撞與交流之平臺、創造更多技術革新的火花。
